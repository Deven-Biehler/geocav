...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new FilterManager(mapRendered, regressionPlot, tableRenderer, pcaPlot); // Filter manager instructs the map renderer on what to display based on user selections
});